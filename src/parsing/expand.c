...
void	handle_character(t_expand *data)
{
	...
	if ((data->input[data->i[0]] == '$' && !data->quotes[0]
			&& is_valid_dollar(data->input, data->i[0]))
		|| (data->input[data->i[0]] == '~' && !data->quotes[0] && !data->quotes[1])
		|| ((data->input[data->i[0]] == '~')
			&& ((data->i[0] == 0 || ft_isspace(data->input[data->i[0] - 1]))
				&& ((data->i[0] == (int)ft_strlen(data->input) - 1) || (data->i[0] < (int)ft_strlen(data->input) - 1 && (ft_isspace(data->input[data->i[0] + 1]) == 1 || data->input[data->i[0] + 1] == '\0'))))))
	{
